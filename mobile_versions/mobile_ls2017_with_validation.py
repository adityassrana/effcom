...
def train(args):
  ...
  s_ssim = tf.summary.scalar("train/multiscale ssim", -10 * tf.log(train_ssim) / np.log(10)) 
  ...
  s_valid_loss = tf.summary.scalar("valid/loss", valid_loss)
  s_valid_mse = tf.summary.scalar("valid/mse", valid_mse)
  s_valid_ssim = tf.summary.scalar("valid/msssim", valid_ssim)
  s_valid_bpp = tf.summary.scalar("valid/bpp", valid_bpp)
