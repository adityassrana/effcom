...
class AnalysisTransform(tf.keras.layers.Layer):
  ...
  def build(self, input_shape):
    self._layers = [
        ...
        tfc.SignalConv2D(
            1, (5, 5), name="layer_3dw", corr=True, strides_down=2,
            padding="same_zeros", use_bias=True,
            channel_separable=True,
            activation=None),
        tfc.SignalConv2D(
            self.num_filters, (1, 1), name="layer_3pw", corr=True, strides_down=1,
            padding="same_zeros", use_bias=True,
...
class SynthesisTransform(tf.keras.layers.Layer):
  ...
  def build(self, input_shape):
    self._layers = [
        ...
        tfc.SignalConv2D(
            1, (5, 5), name="layer_2dw", corr=False, strides_up=2,
            padding="same_zeros", use_bias=True,
            channel_separable=True,
            activation=None),
        tfc.SignalConv2D(
            self.num_filters, (1, 1), name="layer_2pw", corr=False, strides_up=1,
            padding="same_zeros", use_bias=True,
